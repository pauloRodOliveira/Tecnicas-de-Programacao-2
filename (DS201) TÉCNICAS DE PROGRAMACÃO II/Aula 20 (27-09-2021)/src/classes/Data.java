...
public class Data<mes> // compulsotiamente (obrigadoriamente) herda de Object: toString(), hashCode, equals(), etc..
{
    ...
    @Override
    public int hashCode() {
        int ret = 10; // um número natural positivo qualquer.
        /*        ^ nem sempre começará com um número quaquer
         quando a classe for herdada de outra, temos que colocar
         int ret = super.hashCode();
        */

        ret = 2*ret + new Byte (this.dia).hashCode();
        //                           ^ caso o atributo seja um objeto
        // if(this.dia!=null) ret = 13*ret + this.dia.hashCode();
        ret = 2*ret + new Byte (this.mes).hashCode();
        ret = 2*ret + new Short(this.ano).hashCode();
        //    ^ número primo qualquer.
