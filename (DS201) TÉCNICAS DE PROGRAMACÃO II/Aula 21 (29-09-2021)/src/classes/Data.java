...
public class Data implements Cloneable, Comparable<Data> // sempre que utilizamos o compareTo() colocamos que ele é Comparable<classe>
{
    ...
    @Override // o Override vai sobrescrever o método toString() na classe Objectdo qual a classe Data foi herdada compulsóriamente.
    ...
    * deveremos retornar um valor NEGATIVO, caso this seja MENOR que data
    * deveremos retornar um valor POSITIVO, caso this MAIOR que data.
    * deveremos retornar ZERO, caso this seja IGUAL a data
    */
